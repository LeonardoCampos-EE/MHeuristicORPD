...
def showSurface(surfaceArray, globalOptima, figSize = (800, 600), opacity = 0.7, color = 'HSV'):
...
def showSearch(surfaceArray, globalOptima, popTensor, bestTensor, t = 0, figSize = (800, 600), opacity = 0.7):
    ...
    fig.add_scatter3d(
        x = [Alpha[0]], y = [Alpha[1]], z = [zAlpha + off],
        mode = 'markers',
        marker = dict(
            symbol = 'diamond',
            color = 'rgb(12, 13, 130)',
    ...
    fig.add_scatter3d(
        x = [Beta[0]], y = [Beta[1]], z = [zBeta + off],
        mode = 'markers',
        marker = dict(
            symbol = 'diamond',
            color = 'rgb(220, 221, 28)',
            size = 4
        ),
        name = 'Beta wolf'
    )
    ...
    fig.add_scatter3d(
        x = [Delta[0]], y = [Delta[1]], z = [zDelta + off],
        mode = 'markers',
        marker = dict(
            symbol = 'diamond',
            color = 'rgb(255, 6, 0)',
...
def showAnimation(surfaceArray, globalOptima, popTensor, bestTensor, 
figSize = (800, 600), opacity = 0.7, notebook=False, frameDuration = 500):
    ...
    if notebook:
        pyo.iplot(
            fig,
            image_width = figSize[0],
            image_height = figSize[1]
        )
    else:
        fig.show()
    return
